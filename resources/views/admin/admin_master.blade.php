...
<html lang="en" dir="ltr">
  ...
  @yield('admin');    
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2019</span> Copyright Easy Dashboard Bootstrap Template by
                <a
                  class="text-primary"
...
<script src="{{ asset('backend/https://maps.googleapis.com/maps/api/js?key=AIzaSyDCn8TFXGg17HAUcNpkwtxxyT9Io9B_NcM') }}" defer></script>
